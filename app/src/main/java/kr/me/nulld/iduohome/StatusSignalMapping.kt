...
internal enum class BatteryGaugeVisual { NORMAL, CHARGING, FAST_CHARGING }

internal fun batteryGaugeVisual(charging: Boolean, fastCharging: Boolean): BatteryGaugeVisual = when {
    !charging -> BatteryGaugeVisual.NORMAL
    fastCharging -> BatteryGaugeVisual.FAST_CHARGING
    else -> BatteryGaugeVisual.CHARGING
}

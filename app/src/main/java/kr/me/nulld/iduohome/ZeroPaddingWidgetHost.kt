...
private fun publishExactWidgetSize(view: AppWidgetHostView, widthDp: Float, heightDp: Float) {
    ...
    val currentSizes = BundleCompat.getParcelableArrayList(
        current, AppWidgetManager.OPTION_APPWIDGET_SIZES, SizeF::class.java)
    val nextSizes = BundleCompat.getParcelableArrayList(

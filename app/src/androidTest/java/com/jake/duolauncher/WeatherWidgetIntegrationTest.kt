...
class WeatherWidgetIntegrationTest {
    ...
    @Test fun weatherCatalogBindsBothProvidersAtTheirActualSizesAndPersists() {
        ...
        shell("cmd role add-role-holder android.app.role.HOME com.jake.duolauncher 0"); shell("input keyevent KEYCODE_HOME")
        ...
        try {
            ...
            val fallback = previousHome.takeIf { it.isNotEmpty() && it != "com.jake.duolauncher" }

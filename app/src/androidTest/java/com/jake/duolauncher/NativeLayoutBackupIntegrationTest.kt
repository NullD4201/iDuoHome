...
class NativeLayoutBackupIntegrationTest {
    ...
    private fun clearFixtureDocument() {
        ...
        shell("run-as com.jake.duolauncher.test mkdir -p files")
        shell("run-as com.jake.duolauncher.test touch files/$marker")
        shell("run-as com.jake.duolauncher.test rm -f files/saf-layout.json")
        val files = shell("run-as com.jake.duolauncher.test ls files").lineSequence().toSet()
        try {
            ...
            shell("run-as com.jake.duolauncher.test rm -f files/$marker")
        }
    }

...
class NativeWidgetProcessDeathIntegrationTest {
    ...
    @Test fun stage1LeaveRequiredConfigurationPending() {
        ...
        val provider = widgets.personalProviders().single { it.provider.packageName == "com.jake.duolauncher.test" &&
        ...
        await { automation.rootInActiveWindow?.packageName == "com.jake.duolauncher.test" && widgets.pendingPlacement?.slot == slot }
    ...
    @Test fun stage3LeaveExistingWidgetReconfigurePending() {
        ...
        await { automation.rootInActiveWindow?.packageName == "com.jake.duolauncher.test" && widgets.reconfigureWidgetId == id }
        SystemClock.sleep(1_000)
    }

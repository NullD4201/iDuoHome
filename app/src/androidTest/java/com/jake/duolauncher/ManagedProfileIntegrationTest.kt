...
class ManagedProfileIntegrationTest {
    ...
    @Test fun personalAndDisposableWorkCopiesRemainIndependentThroughQuietModeAndUninstall() {
        ...
        shell("am start --user $workUserId -a com.jake.duolauncher.test.ENABLE_CROSS_PROFILE_WIDGETS " +
            "-n com.jake.duolauncher.test/.ProfileFixtureActivity --es widgetPackage $removablePackage " +
        ...
        val fixture = ComponentName("com.jake.duolauncher.test", "com.jake.duolauncher.test.ProfileFixtureActivity")
        ...
        assertTrue(controller.providers(personal).any { it.provider.packageName == "com.jake.duolauncher.test" })

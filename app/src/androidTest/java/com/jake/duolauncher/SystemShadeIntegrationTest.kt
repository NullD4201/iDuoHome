...
class SystemShadeIntegrationTest {
    ...
    private val component = "com.jake.duolauncher/com.jake.duolauncher.SystemShadeAccessibilityService"
    ...
    @Test fun enabledServiceOpensNotificationsAndExpandedQuickSettings() {
        ...
        try {
            ...
            stage = "collapse"
            await {
                automation.rootInActiveWindow?.packageName?.toString() == "com.jake.duolauncher" &&
            ...
            assertEquals("com.jake.duolauncher", automation.rootInActiveWindow?.packageName?.toString())

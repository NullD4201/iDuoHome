...
class WeatherWidgetIntegrationTest {
    ...
    @Test fun weatherCatalogBindsBothProvidersAtTheirActualSizesAndPersists() {
        ...
        shell("cmd role add-role-holder android.app.role.HOME kr.me.nulld.iduohome 0"); shell("input keyevent KEYCODE_HOME")
        ...
        try {
            ...
            listOf(currentPlacement, timelinePlacement).forEach { placement ->
                instrumentation.runOnMainSync {
                    ...
                    val sizes = BundleCompat.getParcelableArrayList(
                        options, AppWidgetManager.OPTION_APPWIDGET_SIZES, android.util.SizeF::class.java)
            ...
            val fallback = previousHome.takeIf { it.isNotEmpty() && it != "kr.me.nulld.iduohome" }

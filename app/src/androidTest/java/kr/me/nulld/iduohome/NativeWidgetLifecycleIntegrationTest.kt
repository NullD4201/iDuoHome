...
class NativeWidgetLifecycleIntegrationTest {
    ...
    @Test fun mandatoryConfigurationReturnsToMainPersistsAndDiscoverStillWorks() {
        ...
        try {
            ...
            tap("Home page 2")
            shell("appwidget revokebind --package kr.me.nulld.iduohome --user 0")
            ...
            click("Cancel")
            await { automation.rootInActiveWindow?.packageName == "kr.me.nulld.iduohome" }
            ...
            click("Place")
            await { automation.rootInActiveWindow?.packageName == "com.android.settings" }
            click("Always allow iDuoHome to create widgets and access their data")
            click("Create")
            ...
            try {
                ...
                try {
                    ...
                    shell("appwidget ${if (hadBindGrant) "grantbind" else "revokebind"} --package kr.me.nulld.iduohome --user 0")

...
class NativeWidgetProcessDeathIntegrationTest {
    ...
    private fun requireSafeHarness() {
        ...
        assertTrue("Harness must make iDuoHome the default Home",
    ...
    @Test fun stage1LeaveRequiredConfigurationPending() {
        ...
        val provider = widgets.personalProviders().single { it.provider.packageName == "kr.me.nulld.iduohome.test" &&
        ...
        await { automation.rootInActiveWindow?.packageName == "kr.me.nulld.iduohome.test" && widgets.pendingPlacement?.slot == slot }
    ...
    @Test fun stage3LeaveExistingWidgetReconfigurePending() {
        ...
        await { automation.rootInActiveWindow?.packageName == "kr.me.nulld.iduohome.test" && widgets.reconfigureWidgetId == id }
        SystemClock.sleep(1_000)
    }

...
class LiveDiscoverIntegrationTest {
    ...
    @Test fun liveFeedTracksHeldEntryExitAndReversalWithoutReplacingHost() {
        ...
        try {
            ...
            instrumentation.runOnMainSync {
                assertTrue("System status bar must remain visible over native Discover",
                    LiveDiscover.owner.get()!!.window.decorView.rootWindowInsets
...
class NativeCallbackHandoffIntegrationTest {
    ...
    @Test fun lateNativeCallbackCannotInterruptNewDuoGesture() {
        ...
        try {
            ...
            assertEquals("A late native callback must not move the active iDuoHome gesture",

...
class SystemShadeIntegrationTest {
    ...
    private val component = "kr.me.nulld.iduohome/kr.me.nulld.iduohome.SystemShadeAccessibilityService"
    ...
    @Test fun enabledServiceOpensNotificationsAndExpandedQuickSettings() {
        ...
        try {
            ...
            stage = "collapse"
            await {
                automation.rootInActiveWindow?.packageName?.toString() == "kr.me.nulld.iduohome" &&
            ...
            assertEquals("kr.me.nulld.iduohome", automation.rootInActiveWindow?.packageName?.toString())

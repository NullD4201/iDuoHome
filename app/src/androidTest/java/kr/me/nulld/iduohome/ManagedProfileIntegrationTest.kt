...
class ManagedProfileIntegrationTest {
    ...
    @Test fun personalAndDisposableWorkCopiesRemainIndependentThroughQuietModeAndUninstall() {
        ...
        assertTrue("iDuoHome must be the default Home before requesting quiet mode",
        ...
        shell("am start --user $workUserId -a kr.me.nulld.iduohome.test.ENABLE_CROSS_PROFILE_WIDGETS " +
            "-n kr.me.nulld.iduohome.test/.ProfileFixtureActivity --es widgetPackage $removablePackage " +
        ...
        val fixture = ComponentName("kr.me.nulld.iduohome.test", "kr.me.nulld.iduohome.test.ProfileFixtureActivity")
        ...
        assertTrue(controller.providers(personal).any { it.provider.packageName == "kr.me.nulld.iduohome.test" })

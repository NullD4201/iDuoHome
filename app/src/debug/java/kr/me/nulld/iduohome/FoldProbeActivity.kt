...
class FoldProbeActivity : ComponentActivity(), SensorEventListener, DisplayManager.DisplayListener {
    ...
    private fun metricsText(): String {
        ...
        return buildString {
            ...
            appendLine("density: ${metrics.density} (${metrics.densityDpi}dpi)  scaled: ${metrics.density * config.fontScale}")
    ...
    private fun wallClock(wallMs: Long): String = requireNotNull(WALL_CLOCK.get()).format(Date(wallMs))
